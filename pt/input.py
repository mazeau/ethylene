...
database(
    ...
    reactionLibraries = [('Surface/Methane/Deutschmann_Pt', False),'2009_Sharma_C5H5_CH3_highP','2015_Buras_C2H3_C4H6_highP','c-C5H5_CH3_Sharma'],
    seedMechanisms = [],
...
catalystProperties(  # Pt111 in old_metal_vals branch
    bindingEnergies = {
        'H': (-2.67,'eV/molecule'),
        'C': (-6.750,'eV/molecule'),
        'N': (-4.08,'eV/molecule'),
