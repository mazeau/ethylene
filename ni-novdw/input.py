# Data sources
database(
    thermoLibraries=['surfaceThermoPt111', 'primaryThermoLibrary', 'thermo_DFT_CCSDTF12_BAC','DFT_QCI_thermo','C3','C10H11','CH',],
    reactionLibraries = ['2009_Sharma_C5H5_CH3_highP','2015_Buras_C2H3_C4H6_highP','c-C5H5_CH3_Sharma'],
    seedMechanisms = [],
    kineticsDepositories = ['training'],
    kineticsFamilies =['default','Surface_Abstraction','Surface_Adsorption_Dissociative','Surface_Adsorption_Dissociative_Double','Surface_Adsorption_Double','Surface_Adsorption_Single','Surface_Dissociation','Surface_Dissociation_Beta','Surface_EleyRideal_Addition_Multiple_Bond','Surface_Migration',],
    kineticsEstimator = 'rate rules',
)

catalystProperties(  # Ni111 in old_metal_vals branch
    bindingEnergies = {
